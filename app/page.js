  ...
  return (
    <>
      <section className="section bg-primary">
        <div className="m-auto relative max-w-screen-2xl overflow-hidden px-6 md:px-10 lg:px-14">
          <h1 className="w-full transition-all ease-in-out duration-100 text-[#1EE07F] flex flex-col justify-center items-center leading-[3rem] sm:leading-[4rem] lg:leading-[8rem]  z-10 tracking-tighter relative top-24 md:top-32 lg:top-40 font-[600] text-[45px] sm:text-[65px] lg:text-[140px]">
            <span>Mortgages</span>
            <span>made simple</span>
          </h1>

          <div className=" w-full  flex flex-col mt-28 md:mt-10  md:flex-row justify-center items-center">
            <div className=" text-white flex flex-col gap-2 justify-center items-center">
              <button className="text-black whitespace-nowrap text-center text-lg font-medium px-12 py-5 bg-[#1EE07F] rounded-full">
                Start my approval
              </button>
            ...
            {/* Google reviews  */}
            <div class="max-md:bg-[#073126] rounded-lg absolute bottom-8 px-3 py-2.5 md:relative md:bg-transparent md:mt-lg">
              ...
              <div class="mt-1  text-[14px] lg:whitespace-nowrap text-white">
