...
export default function ExpertOpinions() {
  ...
  return (
    <div className="bg-[#faf9f7] py-16 px-44">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {experts.map((expert) => (
            <div
              key={expert.id}
              className="bg-[#edf7f1] rounded-2xl p-8 shadow-sm flex flex-col justify-between"
            >
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  {expert.question}
                </h3>
                <p className="text-gray-700 mb-6">{expert.answer}</p>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">NMLS {expert.nmls}</p>
                </div>
              </div>
            </div>
          ))}
