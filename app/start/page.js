     ...
     <Header/>
      ...
      <section className="flex flex-col justify-center relative z-10  py-52 items-center">
        <div className="flex flex-col md:w-[640px]  px-4 gap-10 justify-center">
          <h1 className="flex items-center flex-col font-bold  text-2xl md:text-4xl xl:text-5xl">
            <span>Hi, I'm Betsy!</span>
            <span>What can I help you with?</span>
          </h1>
          <div className="flex gap-8 w-full flex-col text-xl font-bold">
            <button
          ...
          <div className="flex flex-row mt-4 justify-between">
            <div className="flex flex-col gap-6 items-center">
              <span className="text-4xl font-semibold">$100B </span>
              <span className="font-thin text-center">
                home loans funded entirely online
              </span>
            </div>
            <div className="flex  gap-6 flex-col items-center">
              <span className="text-4xl font-semibold">400K </span>
              <span className="font-thin text-center">
          ...
          <div className="bg-[#F0F7F1] text-lg rounded-lg py-8  font-thin text-[#565D5A] flex flex-col items-center gap-5">
            ...
            <div class="flex flex-col gap-3">
              <div class="flex gap-3">
                ...
                <div class="css-1p4jfio">
                  <p class="css-1ddb1th">Custom mortgage rates</p>
                </div>
              </div>
              <div class="flex gap-3">
                <div class="css-o0lktd">
                  <svg
                    class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-1xbrwhv"
                    focusable="false"
                    height={22}
                    width={22}
                    aria-hidden="true"
                ...
                <div class="css-1p4jfio">
                  <p class="css-1ddb1th">Exclusive offers</p>
                </div>
              </div>
              <div class="flex gap-3">
                <div class="css-o0lktd">
                ...
                <div class="css-1p4jfio">
                  <p class="css-1ddb1th">A personalized dashboard</p>
                </div>
              </div>
            </div>
          </div>
