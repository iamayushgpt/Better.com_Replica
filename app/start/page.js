...
const start = () => {
  return (
    <>
      ...
      <section className="flex flex-col justify-center relative z-10  py-52 items-center">
        <div className="flex flex-col md:w-[640px]  px-4 gap-10 justify-center">
          <h1 className="flex items-center flex-col  text-2xl md:text-4xl xl:text-5xl font-sans -apple-system BlinkMacSystemFont Segoe UI, Roboto, Helvetica Neue, sans-serif">
            <span className="font-sans -apple-system BlinkMacSystemFont Segoe UI, Roboto, Helvetica Neue, sans-serif">Hi, I'm Betsy!</span>
            <span>What can I help you with?</span>
          </h1>
          <div className="flex gap-8 w-full font-sans -apple-system BlinkMacSystemFont Segoe UI, Roboto, Helvetica Neue, sans-serif flex-col text-xl ">
            <button
              className="flex transition-all duration-100 ease-in-out justify-start items-center gap-6 px-12 border border-gray-400 rounded-lg py-4 hover:text-secondary hover:shadow-secondary
          ...
          <div className="flex flex-row mt-4 justify-between">
            <div className="flex flex-col gap-6 items-center">
              <span className="text-4xl font-sans -apple-system BlinkMacSystemFont Segoe UI, Roboto, Helvetica Neue, sans-serif">$100B </span>
              <span className="font-thin text-center">
                home loans funded entirely online
              </span>
            </div>
            <div className="flex  gap-6 flex-col items-center">
              <span className="text-4xl font-sans -apple-system BlinkMacSystemFont Segoe UI, Roboto, Helvetica Neue, sans-serif">400K </span>
              <span className="font-thin text-center">
          ...
          <div className="bg-[#F0F7F1] text-lg rounded-lg py-8  font-thin text-[#565D5A] flex flex-col items-center gap-5">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-3">
                ...
                <div className="css-1p4jfio">
                  <p className="css-1ddb1th">Custom mortgage rates</p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="css-o0lktd">
                ...
                <div className="css-1p4jfio">
                  <p className="css-1ddb1th">Exclusive offers</p>
                </div>
              </div>
              <div className="flex gap-3">
                <div className="css-o0lktd">
                ...
                <div className="css-1p4jfio">
                  <p className="css-1ddb1th">A personalized dashboard</p>
                </div>
              </div>
            </div>
          </div>
